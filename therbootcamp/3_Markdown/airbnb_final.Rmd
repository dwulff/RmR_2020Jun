...
# Ergänze caption
cap = "Figure 1. Neueinstellungen pro Monat"
...
<b>Der Anteil von Hotels ist von `r ((Hotel$Anteil[1]-1)*100) %>% round(1)`% im Jahre 2018 auf `r (Hotel$Anteil[2]*100) %>% round(1)`% im Jahre 2019 gestiegen. Es liegt nahe, dass der Anstieg im Anteil der Hotels, den Anstieg der Objektpreise verursacht hat. 
