...
Tabellen mit <highm>table()</highm> direkt ausgeben
...
```{r eval = TRUE}
table(select(airbnb, Preis, Unterkunftsart) %>% slice(1:15))
```
...
Regression mit Vorhersage von Preis durch die Anzahl der Schlafzimmer und das Rating eines Objektes.
