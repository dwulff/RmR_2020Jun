...
.pull-left4[
<ul>
  <li class="m1"><span>Beschreibt wie Tags in HTML angezeigt werden sollen</span></li>
  <li class="m2"><span>Jedem HTML Tag können Styles zugewiesen werden</span></li> 
  <li class="m3"><span>Dafür wird der CSS Selector (h1) mit verschiedenen Deklarationen (zB: color: blue) erweitert</span></li> 
</ul>
...
.pull-left4[
<ul>
  <li class="m1"><span><high>extern</high> mit <link> eigenem .css file</span></li>
</ul>
...
<ul>
  <li class="m1"><span><high>extern</high> mit <link> eigenem .css file</span></li>
  <li class="m2"><span><high>inline</high> direkt im HTML tag </span></li> 
</ul>
