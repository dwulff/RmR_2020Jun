...
<ul>
  <li class="m1"><span>Bisherige Dashboards konnten Popupfenster anzeigen etc. Daten filtern, Variablen auswählen etc. war aber nicht möglich.</span></li>  
...
<ul>
  ...
  <li class="m3"><span><mono>input</mono> kann nur in reaktiver Umwelt gelesen werden.</span></li>
  <li class="m4"><span>Veranlassen, wenn sie verändert werden, dass jeder Codeblock, in dem die Objekte verwendet werden, erneut ausgeführt wird.</span></li>
  <li class="m5"><span>Werden, wie eine Funktion, mit Klammern angesteuert.</span></li>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Statements in <highm>{}</highm> werden als Block ausgeführt und nur das letzte Statement wird zurückgegeben (kreierte Objekte werden aber gespeichert).</span></li>  
</ul>
