...
<ul>
  <li class="m1"><span>Typischerweise einzelseitige <high>Präsentation</high> von Resultaten.</span></li> 
  <li class="m2"><span>Präsentation zusammengehöriger <high>Analysen</high>.</span></li>  
  <li class="m3"><span>Geben einfache <high>Übersicht</high> über wichtigste <high>Parameter/KPIs</high> (Key Performance Indicators).</span></li>
  <li class="m4"><span>Können <high>dynamisch</high> und <high>interaktiv</high> sein.</span></li>
</ul>
...
<ul>
  ...
  <li class="m2"><span>Standard: <high>eine Seite</high>; scrollable und mehrere Seiten
  möglich.</span></li>
  <li class="m3"><span>Standard: <high>spaltenweise</high>; zeilenweise möglich.</span></li>
  <li class="m4"><span>Standard: <high>eine Spalte</high>; mehrere möglich.</span></li>
  <li class="m5"><span><high>Tabs</high> möglich.</span></li>
</ul>
...
.pull-left4[
<ul>
  <li class="m1"><span><high>Seiten</high> werden mit Titel <high>erster Ordnung</high> definiert.</span></li> 
...
.pull-left4[
<ul>
  <li class="m1"><span><high>Spalten/Zeilen</high> werden mit Titel <high>zweiter Ordnung</high> definiert.</span></li> 
  <li class="m2"><span>Konvention: Statt <highm>##</highm> wird <highm>----</highm> verwendet.</span></li> 
...
.pull-left4[
<ul>
  <li class="m1"><span><high>Spalten/Zeilen</high> werden mit Titel <high>dritter Ordnung</high> weiter unterteilt.</span></li> 
...
.pull-left4[
<ul>
  <li class="m1"><span>Mit <highm>{.storyboard}</highm> wird eine Seite als Storyboard definiert</span></li>
...
<ul>
  ...
  <li class="m4"><span><mono>valueBoxe</mono>s.</span></li>
...
<ul>
  <li class="m1"><span>Zeige <high>wichtige Werte.</high></span></li>  
...
<ul>
  ...
  <li class="m2"><span><high>Balkenfarbe</high> kann nach Werten variieren.</span></li>
</ul>
...
<ul>
  <li class="m1"><span><high>Interface</high> zu JS library.</span></li>  
  <li class="m2"><span>Einfaches Erstellen <high>interaktiver Karten</high>.</span></li>
</ul>
...
<ul>
  <li class="m1"><span><high>Interface</high> zu JS library.</span></li>  
  <li class="m2"><span>Einfaches Erstellen <high>interaktiver Plots</high>, vor allem aus <mono>ggplot2</mono> Objekten.</span></li>
</ul>
