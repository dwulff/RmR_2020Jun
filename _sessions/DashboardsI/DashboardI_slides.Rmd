...
<ul>
  ...
  <li class="m3"><span>Headers bestimmen die Boxen und Seiten.</span></li>
  <li class="m4"><span>Standardmässig eine Seite; scrollable und mehrere Seiten
  möglich.</span></li>
...
<ul>
  <li class="m1"><span>Interface zu JS library.</span></li>  
  <li class="m2"><span>Einfaches erstellen interaktive Karten.</span></li>
</ul>
