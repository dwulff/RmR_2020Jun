...
bibliography: 2_Assets/references.json
---
...
<tr>
  <td>
  Das Austattungsmerkmal mit dem grössten Unterschied im Preis ist `r austattung %>% pull(Austattung) %>% first()` (`r austattung %>% pull(Differenz) %>% first()`), das Austattungsmerkmal mit dem kleinsten Unterschied im Preis ist `r austattung %>% pull(Austattung) %>% last()` (`r austattung %>% pull(Differenz) %>% last()`).  
  </td>
  <td>
  </td>
  <td>
