...
2. Das Dokument sollte nun den Code in dem `chunk` nicht mehr zeigen. Mache nun dieses Setting rückgängig, d.h., lösche `echo = FALSE`.   

### F - Neueinstellungen: Text pt. 2

1. Setze eine weitere Überschrift auf vierter Ebene (`####`) mit dem Titel `Stadtteile`.
...
5. Kreiere einen neuen Chunk zwischen den beiden Paragraphen mit dem folgenden Code. 
