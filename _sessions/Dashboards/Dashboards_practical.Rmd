...
3. Setze zunächst das Layout des ganzen Dashboards auf. Verwende dazu zuerst Zeilen von Gleichheitszeichen `========` (dies entspricht Titeln der ersten Stufe, also was du bisher mit einem `#` gekennzeichnet hast).
