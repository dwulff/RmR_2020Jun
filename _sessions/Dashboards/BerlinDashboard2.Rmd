...
renderPlot({
  ...
  pg1 <- ggplot(airbnb_dynamic(), aes(Rating_gesamt)) +
  ...
  pg2 <- ggplot(airbnb_dynamic(), aes(x = log10(Preis), y = Rating_gesamt)) +
...
renderPlot({
  ...
  ps1 <- ggplot(airbnb_dynamic(), aes(Rating_sauberkeit)) +
    geom_histogram(binwidth = 1) +
  ...
  # Erstelle das Streudiagramm für den Zusammenhang von Preis und 
  # Sauberkeitsrating
  ps2 <- ggplot(airbnb_dynamic(), aes(x = log10(Preis), y = Rating_sauberkeit)) +
    geom_point(alpha = .25) +
    labs(x = bquote("log"[10]*"(Preis)"),
         y = "Sauberkeitsrating") +
...
renderPlot({
  ...
  pl1 <- ggplot(airbnb_dynamic(), aes(Rating_lage)) +
    geom_histogram(binwidth = 1) +
    labs(x = "Lagerating",
         y = "Häufigkeit") +
    coord_cartesian(xlim = c(0, 10)) +
  ...
  # Erstelle das Streudiagramm für den Zusammenhang von Preis und
  # Lageratings
  pl2 <- ggplot(airbnb_dynamic(), aes(x = log10(Preis), y = Rating_lage)) +
    geom_point(alpha = .25) +
    labs(x = bquote("log"[10]*"(Preis)"),
         y = "Lagerating") +
    coord_cartesian(ylim = c(0, 10)) +
