...
2. Verschiedene Arten von Inhaltsverzeichnissen einbauen 
...
3. Schliesslich wollen wir nur das Ergebnis im HTML file sehen (ohne Code)
````Markdown
{r echo = XXX}
XXX %>%
  select(XXX, XXX, XXX) %>%
...
7. Jetzt noch die Breite der Tabelle reduzieren und die Schriftgrösse erhöhen - hier
