...
2. In einem eigenem Code Chunk eine Regression berechnen in der `Preis` mit verschiednen Ausstattungsmerkmalen vorhergesagt wird. Diesen Chunk nicht augeben!
