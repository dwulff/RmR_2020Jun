...
3. Füge eine Caption mit `caption = 'Tabelle 1. Austtatung und Einfluss auf den Preis'` ein.
...
2. Berechne eine Regression in der `Preis` mit verschiednen Ausstattungsmerkmalen vorhergesagt wird sowie den  durchschnittlichen Anteil der Hotels. Diesen Chunk nicht augeben!
...
3. Füge einen neune Tabellentitel ein: `title = 'Table 2. Regression des Preises auf die Ausstattung.'`
