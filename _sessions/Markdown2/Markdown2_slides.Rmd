...
.pull-left4[
<ul>
  <li class="m1"><span> <highm>include = FALSE:</highm>  Code und Ergebnisse werde nicht angezeigt</span></li>  
</ul>
...
.pull-left4[
<ul>
  <li class="m1"><span> <highm>include = FALSE:</highm> Code und <high>Ergebnisse werde nicht angezeigt</high></span></li>  
  <li class="m2"><span><highm>echo = FALSE</highm>: Code wird nicht angezeigt, <high>Ergebnisse werden gezeigt</high> </span></li>
</ul>
...
```{r echo = FALSE}
select(airbnb, Preis, Erstellungsdatum, Unterkunftsart)
```
...
<ul>
  <li class="m1"><span> <highm>include = FALSE:</highm> Code und <high>Ergebnisse werde nicht angezeigt</high></span></li>  
  <li class="m2"><span><highm>echo = FALSE</highm>: Code wird nicht angezeigt, <high>Ergebnisse werden gezeigt</high> </span></li>
  <li class="m3"><span><highm>message = FALSE:</highm> Warnungen unterdrücken</span></li>
</ul>
...
<ul>
  ...
  <li class="m2"><span><highm>echo = FALSE</highm>: Code wird nicht angezeigt, <high>Ergebnisse werden gezeigt</high> </span></li>
  <li class="m3"><span><highm>message = FALSE:</highm> Warnungen unterdrücken</span></li>
  <li class="m4"><span><highm>fig.width </highm>= '...', <highm>fig.height</highm> = '...'</li>
</ul>
...
.pull-right5[
<p align="center" width="100%">
  <img src="image/_Screenshots/markdown_screen.001.png" alt="TOC Demo" style="width:70%">
</p>
...
<p align="center" width="100%">
 <img src="image/_Screenshots/markdown_screen.003.png" alt="TOC Demo" style="width:150%">
</p>
]
...
Tabellen werden mit <highm>table()</highm> angezeigt werden- sind dann allerdings nicht schön formatiert ... 
