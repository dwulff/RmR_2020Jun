...
1. Füge nach dem `setup` Chunk in einer neuen Zeile `# Neueinstellungen` ein. Damit erstellst du deinen ersten Zwischenslide mit grauem Hintergrund.
...
10. `Knitte` das Dokument. Der letzte Slide sollte die Grafik 1 enthalten.
