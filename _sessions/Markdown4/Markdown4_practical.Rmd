...
4. Verändere nun die `cell_spec` Funktion so, dass Zellen mit einer Zahl > 100 rot angezeigt werden.
...
1. Slides können sehr gut über einen Browser als PDF ausgegeben werden. Öffne hierzu die durch das Knitten erzeugte `.html` Datei in einem Browser (z.B., Chrome). 
